...
if __name__ == '__main__':
    # some random points
    points = np.array([[0.53135758, -0.25818091],
                       [0.58368177, -0.3286576],
                       [0.18741533, 0.03066228],
                       [0.65685862, -0.09220681],
                       [0.63137604, -0.22978685],
                       [0.59683195, -0.15111101],
                       [0.68646128, 0.0046802],
                       [0.62311759, 0.0101013]])
    A_outer, centroid_outer = outer_ellipsoid_fit(points)
    print(A_outer,centroid_outer)